...
def index(request):
	# return render(request, request.LANGUAGE_CODE +'_bau_index.html', {})
	# return lulc(request)
	return lulc_model(request)

def lulc_model(request):
	return render(request, 'bau_lulc_model.html', {})
...
def carbon_sequestration(request, period = None):
	return process_carbon(request, period, "bau_carbon_sequestration.html", "s", "RATE")

def carbon_peat(request, period = None):
	return process_carbon(request, period, "bau_carbon_peat.html", "p", "DATA")

def biodiversity_emission(request):
	return render(request, 'bau_biodiversity_emission.html', {})

def biodiversity_sequestration(request):
	return render(request, 'bau_biodiversity_sequestration.html', {})

def biodiversity_peat(request):
	return render(request, 'bau_biodiversity_peat.html', {})
...
def economic_profitability(request, period = None):
	...
	return render(request, 'bau_economic_profitability.html', context)

def market(request):
	return render(request, 'bau_market.html', {})

def issue(request):
	return render(request, 'bau_issue.html', {})
